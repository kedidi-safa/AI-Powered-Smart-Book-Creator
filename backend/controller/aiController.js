...
const generateOutline = async (req, res) => {
  try {
    ...
    const prompt = `You are an expert book outline generator. Create a comprehensive book outline based on the folowing requirements:
    Topic: "${topic}"
    ...
    Requirements:
    1. Generate exactly ${numChapters || 5}
    ...
    4. Ensure the chapters build upon each other coherently and have approximately the same size
    5. Match the "${style}" writing style in your titles and descriptions

    Output Format:
    Return ONLY a valid JSON array with no additional text, markdown, or formatting. Each object muct have exactly two keys: "title" and "description".
    Example structure:
    [
        {
