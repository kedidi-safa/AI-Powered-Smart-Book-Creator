...
import { Eye, Maximize2, Sparkle, Type } from "lucide-react";
  ...
  const formatMarkdown = (content) => {
    return (
      content
        ...
        .replace(
          /^# (.*$)/gm,
          '<h1 class="text-3xl font-bold mb-6 mt-8">$1</h2>',
        )
        // Bold
        ...
        .replace(
          /^> (.*$)/gm,
          '<blockquote class="border-l-4 border-yellow-500 pl-4 italic text-gray-700 my-4">$1</blockquote>',
        )
        // Unordered list
    ...
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 text-lg">Select a chapter to edit</p>
                      ...
                      <div
                        ...
                        dangerouslySetInnerHTML={{
                          __html: currentChapter.content
                            ...
                            : '<p class="text-gray-400">No content yet. Start writing to preview',
                        }}
                      ></div>
                    </div>
                  </div>
